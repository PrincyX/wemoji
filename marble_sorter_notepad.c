...
int cooldown;      // Cooldown, a period of complete stillness
int ramp_id;		// A unique way for identifying the two seperate paths of that ramp.
                //IMPORTANT: ramp_id 100 = Light Marble Ramp Config., 1 ramp_id = Dark Marble Ramp Config.

int ralmotsp; //Defines the speed of motor b (regulator motor)
int rampmove; //Defines the speed of motor a and c (ramps)
/*
---------------------------------MAIN PROGRAM-----------------------------------
...
task main(){
     ...
     ramp_id = 100; //initialize ramp to light ramp config. (refer to line 14 of the code)
     control_motor = 250;
     aim_motor = 550;
     cooldown = 2000;
     ralmotsp = 100;
