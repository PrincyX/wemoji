  ...
  <div className="px2 py4 bg-light">
    <div className="container mx-auto">
      <div className="sm-col-8 mx-auto">
        ...
        <p className="mb4 h2">
          What's a <strong>div</strong>
          moji? A diverse set of 200+ emoji inclusive of all skin tones. You can also intregrate this emoji pack anywhere you want. Here’s a preview...
        </p>
